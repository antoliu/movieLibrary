...
public class LibraryService {
    ...
    public ResponseEntity<Collection<Movie>> getMovieByTitle(String title) throws MovieException, RepositoryException {
        ...
        ResponseEntity<Collection<Movie>> response = new ResponseEntity<>(result, HttpStatus.OK);
        return response;
    }
     ...
     * @returnA Response Entity with <strong>confirmation message</strong> or, if list is empty, an <strong>error message</strong>.
     * @throws MovieException
     * @throws RepositoryException
     */
